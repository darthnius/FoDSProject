...
print(f"Best number of features (RF): {best_k}")
print(f"Accuracy with {best_k} features (RF): {results[best_k]}")
...
plt.title('Feature Selection using ANOVA for RF')
plt.grid()
plt.savefig('../output/feature_selection_rf.png')
plt.show()
...
conf_matrix_df.to_csv('../output/confusion_matrix_rf.csv')

# Convert classification report to a DataFrame
class_report_df = pd.DataFrame(class_report).transpose()
class_report_df.to_csv('../output/classification_report_rf.csv')
